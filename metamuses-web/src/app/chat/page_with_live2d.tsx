...
const Live2DCompanionDisplay = dynamic(
  () => import('@/components/live2d/Live2DCompanionDisplay').then(m => ({ default: m.Live2DCompanionDisplay })),
  { ssr: false }
);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col lg:flex-row h-[calc(100vh-80px)] overflow-hidden">
        ...
        <div className={`flex flex-col ${showLive2D ? 'w-full lg:w-1/2' : 'w-full'} transition-all duration-300`}>
                ...
                <div className="neural-card rounded-2xl p-6 h-full">
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <button
                      ...
                      className="p-2 rounded-lg bg-gray-800/50 hover:bg-purple-600/20 transition-all"
                      title={showLive2D ? "Hide Avatar" : "Show Avatar"}
                    >
                      {showLive2D ? "👁️" : "👁️‍🗨️"}
                    </button>
                  </div>
                  ...
                  {apiHealthy === false && (
                    <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4 mt-4">
                      ...
                      <p className="text-xs text-gray-400">
                        The backend server is not responding. Please ensure it's running.
                      </p>
                    </div>
                  )}
                </div>
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              {showLive2D && (
                                <span className="text-xs text-purple-400">✨ Live2D Active</span>
                              )}
                            </div>
                          </div>
                        </div>
                    ...
                    {!walletConnected && (
                      <div className="text-center py-12">
                        ...
                        <p className="text-gray-400 mb-6">
                          Connect your wallet to start chatting with AI companions
                        </p>
                        <ConnectButton />
                      </div>
                    )}
                    ...
                    <div className="p-6 border-t border-gray-700/50">
                      <div className="flex space-x-3">
                        ...
                        <button
                          ...
                          disabled={
                            !inputMessage.trim() || apiLoading || !selectedCompanion
                          }
