...
import { useAuthenticatedChat, checkAPIHealth } from "@/hooks/useAuthenticatedChat";
...
export default function ChatPage() {
  ...
  // Authenticated API integration with EIP-712 signing
  const {
    sendMessage,
  ...
  const handleSendMessage = async (messageContent?: string) => {
    ...
    try {
      // Call authenticated API with companion personality (EIP-712 signed)
              ...
              <div className="lg:col-span-3 flex flex-col">
                <div className="neural-card rounded-2xl flex flex-col h-full">
                  ...
                  <div className="flex-1 overflow-y-auto p-6 space-y-4 max-h-[calc(100vh-400px)]">
                    ...
                    {isSigning && (
                      <div className="flex items-center space-x-2 p-4 text-purple-400">
                    ...
                    {isTyping && !isSigning && <TypingIndicator />}
